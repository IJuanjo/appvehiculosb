...
class Motocicleta extends Vehiculo implements IVehiculo
{
    ...
    public  function  store()
    {
        ...
        WHERE NOT EXISTS (
            SELECT linea,nmotor FROM vehiculos   WHERE linea='motocicleta' and nmotor = '$nmotor'
        ) LIMIT 1;";
    ...
    {
        $nmotor = $this->getNmotor();
        $sql = "DELETE FROM vehiculos  where  linea='motocicleta' and   nmotor='$nmotor'";
    ...
    public function update()
    {
        ...
        $color = $this->getColor();
        $nmotor = $this->getNmotor();
        $sql="UPDATE vehiculos set marca='$marca',linea='$linea',modelo='$modelo',cilindraje='$cilindraje',color='$color',nmotor='$nmotor' where  linea='motocicleta' and   nmotor='$nmotor'";
        $resultadoremove = $this->getDB()->query($sql);
        $confirm = false;
        $resultadoremove ? $confirm = true : false;
        return $confirm;        
